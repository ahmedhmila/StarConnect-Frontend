export default function Footer() {
  return (
    <footer className="bg-official-blue text-white pt-16 pb-8">
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
        <div>
          <h3 className="font-serif font-bold text-2xl mb-4 text-official-gold">Mairie de StarConnect</h3>
          <p className="opacity-80 max-w-sm">
            Empowering citizens and leaders through secure, sovereign technology. Built for the ARITED Challenge.
          </p>
        </div>
        
        <div className="bg-white/5 p-8 rounded-lg border border-white/10">
          <h4 className="font-bold mb-2">Official Newsletter</h4>
          <p className="text-sm opacity-70 mb-4">Receive official statements directly. No algorithms.</p>
          <div className="flex gap-2">
            <input 
              type="email" 
              placeholder="citizen@cameroon.cm" 
            ...
            />
            <button className="bg-official-gold text-official-blue font-bold px-6 py-2 rounded hover:bg-white transition">
              Join
            </button>
          </div>
        </div>
